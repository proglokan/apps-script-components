import { fetchSheet, getSheetHeaders, getColumn } from "../../global/global";
...
const doGet = (request) => {
    ...
    if (targetRow === -1)
        return missingSkuHandler(sku);
    const returnData = {};
    const targetRowValues = sheetValues[targetRow];
